...
const kevin = new Person({name:'kevin', age: 33});
kevin.intro(); // the 'this' in ${this.name} and ${this.age} now refers to the context of the kevin element.
...
const kevinHobbies = sayHobbie.bind(kevin, ...myHobbies);
kevinHobbies();
